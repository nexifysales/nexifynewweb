 ...
 *
 * Usage:
 *   <script src="chatbot/widget.js" data-api="chatbot/api" data-site-root="../"></script>
 *
 * Or initialize manually:
 *   NexifyBot.init({ apiUrl: 'chatbot/api', siteRoot: '../' });
 */
...
(function() {
  ...
  var API_URL = (SCRIPT_TAG && SCRIPT_TAG.getAttribute('data-api')) || 'chatbot/api';
