...
$pageDescription = 'LoyaltyGO: το πρόγραμμα επιβράβευσης που ανοίγει με ένα σκανάρισμα QR — χωρίς app store, με το δικό σου brand. Έτοιμο για café, γυμναστήρια, λιανική, πρατήρια, πλυντήρια αυτοκινήτων και κάθε κλάδο.';
  ...
  <div class="wrap">
    ...
    <div class="vgrid">
      ...
      <article class="vcard" style="--v:var(--v-gym)">
        ...
        <a class="vlink" href="https://gymgo.nexify.gr/" target="_blank" rel="noopener">Δοκίμασέ το live <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M13 6l6 6-6 6"/></svg></a>
      </article>
      ...
      <article class="vcard" style="--v:var(--v-carwash)">
        ...
        <div class="vreward">Πόντοι σε <b>κάθε πλύσιμο</b> που γίνονται δωρεάν υπηρεσίες, αξεσουάρ &amp; τεχνικές εργασίες — ο πελάτης βρίσκεται με την <b>πινακίδα</b> του.</div>
